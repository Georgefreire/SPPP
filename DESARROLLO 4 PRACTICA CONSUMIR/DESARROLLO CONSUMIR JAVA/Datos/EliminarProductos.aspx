<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EliminarProductos.aspx.cs" Inherits="Datos_EliminarProductos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <p>
        <span class="style7"><strong>ELIMINAR</strong></span><br />
&nbsp;
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        style="color: #FF0000; font-weight: 700" Text="Label"></asp:Label>
                <br />
            <asp:GridView ID="dg1" runat="server" AutoGenerateColumns="False" AutoPostBack="True"  
                BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" 
                CellPadding="4" CellSpacing="2" DataKeyNames="ProductID" ForeColor="Black" 
